...
/**
 * A derivation of NotificationClientException that allows the httpCode to be overridden (in the
 * base class it's package scope access). If they didn't want anyone to do this they would have made
 * it final ...
 */
