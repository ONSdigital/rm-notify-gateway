...
public class CommsTemplateClientTest {
    ...
    public void testMakesCorrectGetRequest() throws CommsTemplateClientException, IOException {
        ...
        Mockito.when(restTemplate.exchange(any(URI.class), eq(HttpMethod.GET),
                any(HttpEntity.class), eq(String.class))).thenReturn(new ResponseEntity(HttpStatus.OK));
        ...
        Mockito.when(objectMapper.readValue(nullString, CommsTemplateDTO.class)).thenReturn(CommsTemplateDTO.builder().build());
    ...
    public void testThrowsExceptionWhenUnableToFindTemplate() {
        //Given
        Mockito.when(restTemplate.exchange(any(URI.class), eq(HttpMethod.GET),
                any(HttpEntity.class), eq(String.class))).thenReturn(new ResponseEntity(HttpStatus.BAD_REQUEST));
