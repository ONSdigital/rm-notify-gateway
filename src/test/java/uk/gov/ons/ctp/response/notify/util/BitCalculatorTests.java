...
public class BitCalculatorTests {
  ...
  public void testValidNotifyKey() {
    BitCalculator.KeyInfo info =
        this.bitCalculator.analyseNotifyKey(
            "rmnotifygatewayfixes1-7c1b5868-f1d9-48af-a12f-b68d5e0905c2-2e58b9a4-d9bc-11e7-9296-cec278b6b50a");
  ...
  public void testInvalidNotifyKey() {
    BitCalculator.KeyInfo info =
        this.bitCalculator.analyseNotifyKey(
            "rmnotifygatewayfixes1-7c1b5868-f1d9-48af-a12f-b68d5e0905c2");
  ...
  public void testBrokenKey() {
    BitCalculator.KeyInfo info =
        this.bitCalculator.analyseNotifyKey(
            "brokenkey-qfffffff-ffff-ffff-ffff-ffffffffffff-ffffffff-ffff-ffff-ffff-ffffffffffff");
  ...
  public void testTemplateId() {
    BitCalculator.KeyInfo info =
        this.bitCalculator.analyseHexNumber("fb7b617a-d5ce-4c0c-812b-e0c3c3a29e2d");
  ...
  public void testDummyTemplateId() {
    BitCalculator.KeyInfo info =
        this.bitCalculator.analyseHexNumber("ffffffff-ffff-ffff-ffff-ffffffffffff");
